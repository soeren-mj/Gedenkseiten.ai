...
const ReactionIcons: { [key in ReactionType]: React.ReactNode } = {
  liebe: (
    <svg width="20" height="20" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="mask_liebe" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
        <rect y="0.688477" width="40" height="40" fill="#D9D9D9"/>
      </mask>
      <g mask="url(#mask_liebe)">
  ...
  dankbarkeit: (
    <svg width="20" height="20" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="mask_dankbarkeit" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="41" height="41">
        <rect x="0.75" y="0.688477" width="40" height="40" fill="#D9D9D9"/>
      </mask>
      <g mask="url(#mask_dankbarkeit)">
  ...
  blumen: (
    <svg width="20" height="20" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="mask_blumen" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="41" height="41">
        <rect x="0.25" y="0.688477" width="40" height="40" fill="#D9D9D9"/>
      </mask>
      <g mask="url(#mask_blumen)">
  ...
  kerze: (
    <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="mask_kerze" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="40">
        <rect width="40" height="40" fill="#D9D9D9"/>
      </mask>
      <g mask="url(#mask_kerze)">
