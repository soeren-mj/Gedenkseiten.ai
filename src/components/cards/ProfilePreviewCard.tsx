...
import Reactions, { Reaction } from '../ui/Reactions';
    ...
    <div className="w-[427px] max-w-full bg-white rounded-[28px] p-2 sm:p-2 flex flex-col gap-8 shadow border border-[#D2D3D9] mx-auto">
      ...
      <div className="flex flex-col items-end">
        <div className="w-full aspect-square relative">
          <Image
            src={isAnimal ? "/images/gedenkseite-tier.png" : "/images/profil-gedenkseite-jaune-pieree-mont-dereville.png"}
            alt={isAnimal ? "Profilbild Tier" : "Profilbild Jaune Pierreen Mont-Dereville"}
            fill
      ...
      <div className="flex flex-col gap-6 px-2">
        <div>
          ...
          <div className="flex flex-col gap-2">
            <div className="font-satoshi font-medium text-[2rem] leading-[1.2] tracking-[-0.09375rem] text-black sm:text-[32px] sm:tracking-normal">
              {isAnimal ? 'Bruno' : 'Jaune Pierreen\nMont-Dereville'}
            </div>
            {isAnimal && (
            ...
            <div className="flex flex-col gap-1 text-[14px] text-[#636573] font-inter">
              <div className="flex gap-2 items-center">
                ...
                <span>{isAnimal ? 'Hamburg' : 'Isaoberammergau'}</span>
              </div>
              <div className="flex gap-2 items-center">
                <span>†</span>
      ...
      {/* Reaktionen */}
      <div className="border-t border-b border-[#D2D3D9] py-4 px-5 flex flex-col gap-4">
        <div className="text-[14px] font-inter font-semibold text-[#1F2024] mb-2">Reaktionen</div>
        <Reactions reactions={reactions} onReactionClick={(reaction) => {
