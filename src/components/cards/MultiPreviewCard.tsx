...
const MultiPreviewCard: React.FC<MultiPreviewCardProps> = ({ type = 'family' }) => {
  ...
  return (
    <div className="w-[427px] max-w-full bg-white rounded-[28px] p-2 sm:p-2 flex flex-col gap-8 shadow border border-[#D2D3D9] mx-auto">
      {/* Name section moved above image */}
      <div className="flex flex-col gap-2 px-2 pt-4">
        <div className="font-satoshi font-medium text-[2rem] leading-[1.2] tracking-[-0.09375rem] text-black sm:text-[32px] sm:tracking-normal text-center">
          {type === 'family' ? 'Familie Mont-Dereville' : 'Lawinenunglück Alpen – 16.01.2019'}
        </div>
      </div>
      ...
      <div className="flex flex-col items-end">
        <div className="w-full aspect-square relative">
          <Image
            src={type === 'family' ? "/images/familie-gedenkseite.png" : "/images/ereignis-gedenkseite.png"}
            alt={type === 'family' 
              ? "Familie Mont-Dereville - Eine würdevoll gestaltete digitale Gedenkseite für die ganze Familie" 
              : "Lawinenunglück Alpen - Digitale Gedenkseite für die Opfer des tragischen Ereignisses vom 16.01.2019"}
            fill
      ...
      >
        {type === 'family' 
          ? 'Eine Familie, die für immer in unseren Herzen bleibt.'
          : 'Ein tragisches Ereignis, das neun Menschen das Leben kostete.'}
      </div>
        ...
        {type === 'event' ? (
          <div className="mt-4 mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {DECEASED_PERSONS.map((name, index) => (
                <div key={index} className="flex items-center gap-2 w-full">
                  <InitialsAvatar name={name} />
                  <span className="font-inter text-sm text-black truncate">{name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            {/* MiniProfileCards for family members */}
            <div className="flex flex-wrap gap-4 mt-2 justify-center justify-between">
              <MiniProfileCard
                image="/images/profil-gedenkseite-jaune-pieree-mont-dereville.png"
                name="Jaune Pierreen Mont-Dereville"
                birth="01.08.1946"
                death="28.10.2023"
              />
              <MiniProfileCard
                image="/images/claude-mont-dereville.png"
                name="Claude Mont-Dereville"
                birth="01.08.1946"
                death="28.10.2023"
              />
              <MiniProfileCard
                image="/images/gedenkseite-tier.png"
                name="Bruno"
                birth="12.03.2011"
                death="28.10.2023"
              />
